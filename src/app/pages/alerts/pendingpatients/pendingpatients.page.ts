...
@Component({
  selector: 'app-pendingpatients',
  templateUrl: './pendingpatients.page.html',
  styleUrls: ['./pendingpatients.page.scss'],
})
export class PendingpatientsPage implements OnInit {
  ...
  getData(): void {
    this.apiServices.getPendingPatients(this.salesrepid)
      .subscribe(results => {
